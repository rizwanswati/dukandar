...
<head>
        ...
        <meta charset="utf-8" />
        <title>Dashboard | Dukandar - Admin Dashboard</title>
                                        ...
                                        <div class="row">
                                            <div class="col-7">
                                                <div class="text-primary p-3">
                                                    ...
                                                    <p>{{getSessionItem('SessionCore','user_type')}} Dashboard</p>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                ...
                                                <h5 class="font-size-15 text-truncate">{{getSessionItem('SessionCore','username')}}</h5>
                                                <p class="text-muted mb-0 text-truncate">{{getSessionItem('SessionCore','user_type')}}</p>
                                            </div>
