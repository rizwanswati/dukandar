...
$(document).ready(function()
{
    ...
    $("#datatable").DataTable(),
       table =  $('#datatable-buttons').DataTable(
            ...
            "serverSide":true,
            // "scrollX": true,
            "ajax":request_url+"loadCategories",
            "columns":[
                {"data":"category_id"},
                {"data":"category_name"},
        ...
        $('#datatable-buttons').on('draw.dt',function(){
            $('#datatable-buttons').Tabledit({
                url:request_url+'updateCategories',
                method:"POST",
                dataType:'json',
                columns:{
                    ...
                    editable:[
                        ...
                        [3,'category_type','{"within city":"within city","national":"national"}'],
                        [4,"category_priority"],
                        [5,'category_status','{"Active":"Active","Not Active":"Not Active"}'],
                        [6,"category_image_url"]
                    ]
                   },
